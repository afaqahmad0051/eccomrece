        ...
        <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
            <tr>
                ...
                <!-- {{-- <img src="" alt="" width="150"/> --}} -->
                    <h2 style="color: green; font-size: 26px;">
                        <strong>Flipmart</strong>
                    </h2>
                </td>
                <td align="right">
                    <pre class="font" >
                ...
                <td>
                    <p class="font" style="margin-left: 20px;">
                        ...
                        @php
                            ...
                            $area = $order->area->area_name;
                        @endphp
                        <strong>Address:</strong> {{$div}},{{$dist}},{{$area}} <br>
        ...
        <table width="100%">
            ...
            <tbody>
                @foreach ($orderitem as $item)
                    <tr class="font">
                        <td align="center">
                            <img src="{{ public_path($item->product->product_thumbnail) }}" height="60px;" width="60px;" alt="{{ $item->product->product_name_en }}">
                        </td>
                        <td align="center">{{ $item->product->product_name_en }}</td>
                        <td align="center">
                            @if ($item->size == null || $item->size == '' || $item->size == 0)
                                ----
                            @else
                                {{$item->size}}
                            @endif
                        ...
                        <td align="center">
                            @if ($item->color == null || $item->color == '' || $item->color == 0)
                                ----
                            @else
                                {{$item->color}}
                            @endif
