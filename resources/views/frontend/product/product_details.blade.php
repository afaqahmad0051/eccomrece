                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                <span class="price">PKR {{ $product->selling_price }}</span>
                                                @else
                                                <span class="price">PKR {{ $product->discount_price }}</span>
