...
<head>
    ...
    <link rel="stylesheet" href="{{asset('backend/css/toaster.css')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Price: <strong class="text-danger">PKR <span id="pprice"></span></strong> 
                                    <del id="oldprice"></del>
                                </li>
                        ...
                        {{-- End Col-md-4 --}}
                        <div class="col-md-4">
                            <div class="form-group" id="colorProduct">
                              <label for="exampleFormControlSelect1">Choose Color: <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group" id="sizeArea">
                                <label for="exampleFormControlSelect1">Select Size: <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Quantity: <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="qty" value="1" min="1">
                            </div>
                            <input type="hidden" id="product_id">
                            <button type="submit" class="btn btn-success mb-2" onclick="addToCart()">Add to Cart</button>
                        </div>
                        {{-- End Col-md-4 --}}
                    </div>
                </div>
        ...
        function productView(id){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    //Hide if product do not have size
                    if (data.size=="") {
                            $('#colorProduct').hide();
                        } else {
                            $('#colorProduct').show();
                ...
                success:function(response){
                    ...
                    $.each(response.carts, function(key,value) {
                        rows += `<tr>
                                    ...
                                    <td class="col-md-2">
                                        <strong>PKR: ${value.subtotal}</strong>
                                    </td>
                                    <td class="col-md-1 close-btn">
                    ...
                    if (data.total) {
                            ...
                            `<tr>
                                <th>
                                    <div class="cart-sub-total">
                                        Subtotal<span class="inner-left-md">PKR ${data.total}</span>
                                    </div>
                                    <div class="cart-grand-total">
                                        Grand Total<span class="inner-left-md">PKR ${data.total}</span>
                                    </div>
                                </th>
                            </tr>`
                        )
                        ...
                        $('#couponCalField').html(
                            `<tr>
                                <th>
                                    <div class="cart-sub-total">
                                        Subtotal: <span class="inner-left-md">PKR ${data.subtotal}</span>
                                    </div>
                                    <div class="cart-sub-total">
                                        Coupon Code: <span class="inner-left-md">${data.coupon_name}</span>
                                        <button type="submit" onclick="couponRemove()"><i class="fa fa-times"></i></button>
                                    </div>
                                    <div class="cart-sub-total">
                                        Discount Amount: <span class="inner-left-md">PKR ${data.discount_amount}</span>
                                    </div>
                                    <div class="cart-grand-total">
                                        Grand Total: <span class="inner-left-md">PKR ${data.total_amount}</span>
                                    </div>
                                </th>
                            </tr>`
                        )
                    ...
                    success: function(response,data) {
                        ...
                        //    console.log(area)
                            ...
                            for(var i=0;i<length;i++){
                                if(area[i]['area_name']){
                                    options += '<option value="'+area[i]['id']+'">'+area[i]['area_name']+'</option>';
                                }
                            }
