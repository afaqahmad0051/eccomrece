                                            ...
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        ...
                                                        @else
                                                        <div class="product-price"> <span class="price"> PKR {{ $product->discount_price }} </span></div>
                                                        @endif
                                                        <!-- /.product-price -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="item" style="background-image: url({{asset($slider->slider_image)}});">
                            <div class="container-fluid">
                                <div class="caption bg-color vertical-center text-left">
                                    ...
                                    @else
                                    <div class="big-text fadeInDown-1"> {{$slider->title_ur}} </div>
                                    @endif
                                    @if(session()->get('language')=='english')
                                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slider->desc_en}}</span> </div>
                                    @else
                                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slider->desc_ur}}</span> </div>
                                    @endif
                                </div>
                                <!-- /.caption -->
                            </div>
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    <div class="more-info-tab clearfix ">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            @else
                            <li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">{{ $category->category_name_ur }}</a></li>
                            @endif
                            @endforeach
                    ...
                    <div class="tab-content outer-top-xs">
                        ...
                        <div class="tab-pane" id="category{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    <!-- /.item -->
                                    @empty
                                    <h4 class="text text-danger">No Product Available</h4>
                                    @endforelse
                                    <!-- End Forelse for Product  -->
                                </div>
                                <!-- /.home-owl-carousel -->
                            </div>
                            <!-- /.product-slider -->
                        ...
                        <!-- /.tab-pane -->
                        @endforeach
                        <!-- End Foreach For $categories as $category  -->
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        ...
                        @else
                        {{ $skip_category_2->category_name_ur }}
                        @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a href="detail.html"><img src="{{asset('frontend/assets/images/products/p30jpg')}}" alt=""></a> </div>
                                        <!-- /.image -->
