                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="brand_id" id="" class="form-control">
                                                    ...
                                                    <option value="{{ $brand->id }}" {{ ($brand->id == $products->brand_id)?'selected':'' }}>{{$brand->brand_name_en}} - {{$brand->brand_name_ur}}</option>
                                                    @endforeach
                                                </select>
                                                @error('brand_id')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="category_id" id="category_id" class="form-control">
                                                    ...
                                                    <option value="{{ $category->id }}" {{ ($category->id == $products->category_id)?'selected':'' }}>{{$category->category_name_en}} - {{$category->category_name_ur}}</option>
                                                    @endforeach
                                                </select>
                                                @error('category_id')
                                                <span class="text-danger">{{$message}}</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="subcategory_id" id="subcategory_id" class="form-control">
                                                    ...
                                                    <option value="{{ $subcategory->id }}" {{ ($subcategory->id == $products->subcategory_id)?'selected':'' }}>{{$subcategory->subcategory_name_en}} - {{$subcategory->subcategory_name_ur}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="subsubcategory_id" id="subsubcategory_id" class="form-control">
                                                    ...
                                                    <option value="{{ $subsubcategory->id }}" {{ ($subsubcategory->id == $products->subsubcategory_id)?'selected':'' }}>{{$subsubcategory->subsubcategory_name_en}} - {{$subsubcategory->subsubcategory_name_ur}}</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" style="text-align:right;" name="product_name_ur" value="{{$products->product_name_ur}}" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_tags_en" value="{{$products->product_tags_en}}" class="form-control" data-role="tagsinput">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_tags_ur" class="form-control" value="{{$products->product_tags_ur}}" style="text-align:right;" data-role="tagsinput">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_size_ur" value="{{$products->product_size_ur}}" class="form-control" style="text-align:right;" data-role="tagsinput">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Col  -->
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_en" value="{{$products->product_color_en}}" class="form-control" data-role="tagsinput">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_ur" value="{{$products->product_color_ur}}" class="form-control" style="text-align:right;" data-role="tagsinput">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="short_desc_en" id="textarea" class="form-control">{!! $products->short_desc_en !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Col  -->
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="short_desc_ur" id="textarea" style="text-align:right;" class="form-control">{!! $products->short_desc_ur !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Col  -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="editor1" name="long_desc_en" rows="10" cols="80">{!! $products->long_desc_en !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Col  -->
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="editor2" name="long_desc_ur" rows="10" cols="80">{!! $products->long_desc_ur !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Col  -->
        ...
        <div class="col-md-12">
            <div class="box bt-3 border-info">
                <div class="box-header">
                    <h4 class="box-title">Multiple <strong>Images</strong></h4>
                </div>
                <form action="{{ route('update.product.image') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-md-3" style="margin-left: 10px;">
                            <div class="card">
                                <img src="{{ asset($img->photo_name) }}" class="card-img-top" style="width: 280px; height:130px; margin-top:7px;">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <a href="{{route('product.multiimg.delete', $img->id)}}" class="btn btn-danger" id="delete" title="Delete"><i class="fa fa-trash"></i></a>
                                    </h5>
                                    <p class="card-text">
                                    <div class="form-group">
                    ...
                    <div class="form-layout-footer">
                        <input type="submit" class="btn btn-info btn-rounded mb-5" value="Update" style="float: right; margin:10px;">
                    </div>
                </form>
            </div>
        </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box bt-3 border-info">
                <div class="box-header">
                    <h4 class="box-title">Main Thumbnail <strong>Image</strong></h4>
                </div>
                <form action="{{ route('update.product.thumbnail') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        <div class="col-md-3" style="margin-left: 10px;">
                            <div class="card">
                                <img src="{{ asset($products->product_thumbnail) }}" class="card-img-top" style="width: 280px; height:130px; margin-top:7px;">
                                <div class="card-body">
                                    <p class="card-text">
                                    <div class="form-group">
                                        <label class="form-control-label">Change Image <span class="text-danger">*</span></label>
