                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    @elseif($order->status == 'shipped')
                                        <a href="{{ route('shipped-to-delivered',$order->id) }}" class="btn btn-block btn-success" id="delievered">Delivered Order</a>
                                    @elseif($order->status == 'delivered')
                                        <a href="{{ route('delivered-to-cancelled',$order->id) }}" class="btn btn-block btn-danger" id="cancelled">Cancel Order</a>
                                    @endif
                                </th>
                            </tr>
                        </table>
